...
\begin{frame}
    ...
    \begin{exampleblock}{Glede na $\lambda$ karakteriziramo fiksne točke:}
        ...
        \begin{enumerate} 
           \onslide<1-> \item $|\lambda| < 1$ je \textbf{privlačna} fiksna točka.
            \onslide<2->\item $|\lambda| > 1$ je \textbf{odbojna} fiksna točka.
            \onslide<3->\item $|\lambda| = 1$: 
            \onslide<4->\item $|\lambda| = 0$ je \textbf{super privlačna} fiksna točka.
