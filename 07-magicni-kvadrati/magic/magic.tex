...
Magični kvadrat v tabeli \ref{eq:numbers} je normalen.
...
\begin{izrek}
   Magična konstanta normalnega magičnega kvadrata reda \pojem{n}
   je enaka
   \begin{equation}
      % oznaka: eq:mc
...
Kvadratu v tabeli \ref{table:loshu} ustrezata konstanti $A=20$ in $D=1$.
...
Na primer, magičnemu kvadratu Lo Shu (glej tabelo \ref{table:kubera}) priredimo
...
Števila različnih normalnih magičnih kvadratov se nahajajo v tabeli \ref{table:tabela}.
% sklic: table:stevila
